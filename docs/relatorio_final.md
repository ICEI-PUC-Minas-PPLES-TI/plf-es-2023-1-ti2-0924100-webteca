...
| --- | --- | --- | --- | --- | --- |
| Tempo de respota do pedido de remoção | Avaliar o tempo que o avaliador gasta para responder a um pedido de remoção de livro | Tempo de resposta apartir do momento que o pedido é enviado |   | avaliacao_pedido | Processos internos |
