...
| Valor arrecadado (Mensal) | Contrôle financeiro sobre o total de dinheiro arrecadado | Retorna o valor da soma de todos os pagamentos para conta premium feitos no mês | Soma dos valores pagos para uma conta premium | cartao_credito | Processo interno |
